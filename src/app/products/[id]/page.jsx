  ...
  if (!product) {
    return (
      <div className="py-20 text-center">
        ...
        <Link href="/products" className="btn-primary mt-4 inline-flex">Back to Shop</Link>
      </div>
    );
  }
    ...
    <div className="py-10 min-h-screen">
      <div className="page-container">
        <nav className="text-sm text-choco-500 mb-8">
          <Link href="/" className="hover:text-choco-800">Home</Link>
          <span className="mx-2">/</span>
          <Link href="/products" className="hover:text-choco-800">Shop</Link>
          <span className="mx-2">/</span>
              ...
              {user ? (
                ...
                <div className="text-center py-8">
                  <p className="text-choco-600 text-sm mb-4">
                    <Link href="/login" className="text-choco-800 font-semibold underline">Log in</Link> to write a review.
                  </p>
                </div>
              )}
            </div>
